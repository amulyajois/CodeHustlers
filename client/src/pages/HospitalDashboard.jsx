            ...
            {selectedDoctorId && (
              <div className="slot-entry-box">
                ...
                <div className="form-group slot-inputs">
                  ...
                  <input type="text" name="from" placeholder="From (e.g., 10:00 AM)" value={newSlotInput.from} onChange={handleNewSlotInputChange} />
                  <input type="text" name="to" placeholder="To (e.g., 1:00 PM)" value={newSlotInput.to} onChange={handleNewSlotInputChange} />
